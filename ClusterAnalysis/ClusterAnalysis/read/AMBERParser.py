...
class AMBERParser(object):
    ...
    def read_files(self, start, end, step, excluded, hydrogen_bonding, 
        ...
        pdb = PDBFile(self.amb_top)
        read_coords = Universe(pdb, self.amb_coords)
        #read_coords = Universe(self.amb_top, permissive=False)
        ...
        try:
            ...
            self.charges = np.zeros(len(self.atom_names))
